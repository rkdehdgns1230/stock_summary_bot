...
def _parse_chat_ids(raw_chat_ids: str | None) -> list[str]:
    ...
    return [_normalize_chat_id(chat_id) for chat_id in raw_chat_ids.split(',') if chat_id.strip()]


TELEGRAM_TOKEN = os.environ.get('TELEGRAM_TOKEN')
TELEGRAM_CHAT_IDS = _parse_chat_ids(os.environ.get('TELEGRAM_CHAT_IDS'))
