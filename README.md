...
매일 아침 한국 증시 개장 전, 미국 시장 지표 · 국내 야간 선물 · 커뮤니티 여론을 수집하여 **Gemini AI**가 투자 리포트로 요약한 뒤 **텔레그램**으로 자동 전송하는 봇입니다.
...
| 코스피200 야간 선물 수집 | 인베스팅닷컴에서 야간 선물 가격 스크래핑 |
| 커뮤니티 여론 분석 | 에펨코리아 주식 게시판 인기글 상위 15개 본문 수집 |
| AI 리포트 생성 | Gemini 1.5 Flash로 투자 리포트 자동 생성 |
| 텔레그램 전송 | 생성된 리포트를 지정된 텔레그램 채팅으로 전송 |
...
- 인베스팅닷컴은 구조 변경 시 스크래핑이 실패할 수 있습니다.
- 에펨코리아 게시판 접근 시 차단 방지를 위해 게시글당 1초 딜레이가 적용됩니다.
